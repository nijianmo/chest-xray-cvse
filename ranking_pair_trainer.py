...
class DebuggerBase:
    def __init__(self, args):
        ...
        self.load_data()
        self.train_data_loader = self._init_data_loader()
        
        #print('create train_image_dataloader')
        #self.train_image_dataloader = self._init_image_data_loader(self.args.train_image_file_list)
        print('create dev_image_dataloader')
        self.dev_image_dataloader = self._init_image_data_loader(self.args.dev_image_file_list)
    ...
    def load_data(self):
        ...
        print('load report2group_{}.pkl'.format(num_clusters))
    ...
    def train(self):
        ...
        for epoch_id in range(self.start_epoch, self.args.epochs):
            ...
            if epoch_id % 2 == 0: # eval every 2 epochs
                continue
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_embeddings_path', type=str, default='mimic_embeddings.pt',
    ...
    parser.add_argument('--use_linear', action='store_false')
    ...
    if args.load_model_path != '':
        print('Continue training on {}'.format(args.load_model_path))
        debugger._load_mode_state_dict()
